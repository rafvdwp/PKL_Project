...
class AdminSpecificationBulkMaterialController extends Controller
{
    ...
    public function delete($subSystemDescriptionId)
    {
        ...
        return redirect()->route('admin.project.subSystembulkmaterial', ['project' => $specificationbulkmaterial->project_id, 'subSystem' => $specificationbulkmaterial->subSystem_id]);
    }
}
