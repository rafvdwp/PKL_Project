...
@section('content')
    <nav class="bg-gray-800">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">Welcome to Project Site</span>
            </a>
            <div class="flex gap-2 md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <a href="{{ route('admin.project.manageProject') }}">
                    <button
                        ...
                        <div
                            ...
                            <div>
                                <p class="text-md font-normal text-gray-600 dark:text-gray-400 mb-4 bg-gray-200 p-3 rounded"
                                    ...
                                    4. "Status" di dalam tabel akan berubah ketika projek sedang dalam proses, sedang dalam
                                    budgeting, sedang dalam pengerjaan atau sudah selesai.<br>
                                <div class="py-4">
                                    Contoh Status : <br><br>
                                    <div class="block md:block lg:flex justify-center">
                                        <div class="">
                                            <span
                                                class=" bg-yellow-300 text-yellow-500 mr-2 px-3 py-1 font-extrabold text-md items-center text-center rounded-full">
                                                Process..
                                            </span>
                                            <span
                                                class="bg-red-400 text-red-700 mr-2 px-3 py-1 font-extrabold text-md items-center text-center rounded-full">
                                                Budgeting..
                                            </span>
                                        </div>
                                        <div class="mt-5 md:mt-5 lg:mt-0">
                                            <span
                                                class="bg-blue-400 text-blue-700 mr-2 px-3 py-1 font-extrabold text-md items-center text-center rounded-full">
                                                On Progress
                                            </span>
                                            <span
                                                class="text-white px-3 py-1 font-extrabold text-md items-center text-center rounded-full"
                                                style="background-color: rgb(29, 180, 29);">
                                                Done
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    @foreach ($project as $item)
                                        <tr
                                            ...
                                            <th scope="row"
                                                ...
                                                <a
                                                    href="{{ route('project.show', ['user' => $item->user_id, 'project' => $item->id]) }}">{{ $item->name }}</a>
                                            </th>
                                            <td class="px-6 py-4 gap-2 justify-center">
                                                <div
                                                    class="bg-yellow-300 text-yellow-500 py-1 font-extrabold text-md items-center text-center rounded-full">
                                                    Process..
                                                </div>
                                            </td>
                                            ...
                                            <td class="px-6 py-4 flex gap-2 justify-center">
                                                {{-- <button onclick="initiateCopyProject('{{ $item->id }}')" class="inline-flex items-center px-3 py-1 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"></path>
                                            </svg>
                                            Copy
                                        </button> --}}
                                                <a href="{{ route('project.show', ['user' => $item->user_id, 'project' => $item->id]) }}"
                                    ...
                                    <div class="relative w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                                                ...
                                                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600" data-modal-hide="copyProjectModal">
                                            ...
                                            <form id="copyProjectForm" method="POST" class="p-4 md:p-5">
                                                ...
                                                <div class="grid gap-4 mb-4">
                                                    <div>
                                                        <label for="projectName" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">New Project Name</label>
                                                ...
                                                <button type="submit" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700">
                                                    Copy Project
                                                </button>
                                            </form>
                                        </div>
    ...
    @include('users.project.create')

    {{-- Edit Modal --}}
    @include('users.project.edit')
@endsection
