...
@section('content')
    ...
    <section class="bg-gray-500 bg-blend-multiply" style="background-image:url(https://www.rekayasa.com/wp-content/uploads/2021/06/FIP_7973-copy.jpg); background-size:cover; background-position:center; background-repeat:no-repeat; height:cover;">
                    ...
                    <div class="mx-auto max-w-8xl">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div class="mb-2 bg-gray-800 border-solid rounded-lg shadow-sm w-full">
                                <form action="{{ route('admin.manageSpecification.store') }}" method="post">
                                @csrf
                                    <div class="bg-gray-700 px-3 py-3 border-solid w-full font-extrabold text-md text-gray-400 rounded-r-lg">
                                        Specification Management
                                    </div>
                                    <div class="p-3 block">
                                        <div class="flex">
                                        ...
                                        <label class="block w-1/2" style="max-width:865px;">
                                            <span class="text-sm font-bold text-gray-200">
                                                Add New Specification Name
                                            </span>
                                            <div class="block">
                                                <textarea type="text" value="{{ old('specification_name') }}"
                                        ...
                                        <div class="flex justify-end">
                                            <button class="mt-3 bg-gray-700 hover:bg-green-800 text-white font-bold py-2 px-4 rounded-full text-right">
                                                Submit
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="flex mx-auto max-w-screen-xl">
                        <main class="w-full">
                            <div class="mx-auto max-w-8xl px-4 sm:px-2">
                                <div class="grid grid-cols-1 gap-4">
                                    <div class="flex">
                                        <div class="text-gray-400 font-bold h w-1/2 text-3xl pl-6">Table Specification</div>
                                        <div class="w-full flex justify-end">
                                        <form class="max-w-md w-full border rounded-lg">
                                            <div class="flex">
                                                <div class="relative w-full">
                                                    <input type="search" id="search-dropdown" class="rounded-lg block p-2.5 w-full z-20 text-sm rounded-e-lg border-s-2 border focus:ring-blue-500 bg-gray-700 border-s-gray-700  border-gray-600 placeholder-gray-400 text-white focus:border-blue-500" placeholder="Search Subsystem, description, specification" required />
                                                    <button type="submit" class="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white rounded-e-lg border-l border-gray-300 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-500 bg-gray-700">
                                    ...
                                    <table class="text-sm text-left rounded rtl:text-right text-gray-00">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd:bg-gray-900 even:bg-gray-800 border-b border-gray-500">
                                                <td class="px-6 py-4 gap-2 font-medium text-left text-white" style="max-width: 100px; word-wrap: break-word; white-space: normal; overflow-wrap: break-word;">
                                                    {{ $item->name }}
                                                </td>
                                                <th scope="row" class="px-6 py-4 font-medium text-white text-left" style="max-width: 225px;  word-wrap: break-word; white-space: normal; overflow-wrap: break-word;">
                                                    {{ $item->Description_name }}
                                                </th>
                                                <td class="px-6 py-4 gap-2 font-medium text-left text-white" style=" max-width: 225px; word-wrap: break-word; white-space: normal; overflow-wrap: break-word;">
                    ...
                    <div class="mx-auto">
                        <div class="grid grid-cols-1 gap-4">
                            <div class="mb-2 bg-gray-800 border-solid rounded-lg shadow-sm">
                                    <div class="bg-gray-700 px-3 py-3 border-solid font-extrabold text-md text-gray-400 rounded-r-lg">
                                        Detail Specification Management
                                    </div>
                                <form action="{{ route('admin.manageSpecification.DetailSpecificationStore') }}" method="post">
                                    @method('post')
                                    @csrf
                                    <div class="p-3 block">
                                        <div class="flex w-full justify-between">
                                            <div class="flex w-full">
                                                <label class="block w-full">
                                                    <span class="text-sm font-bold text-gray-200">
                                                        Add New Detail Specification
                                                    </span>
                                                    <textarea type="text" value="{{ old('DetailSpecification') }}" name="DetailSpecification" 
                                        ...
                                        <div class="flex justify-end">
                                            <button type="submit" class="mt-3 bg-gray-700 hover:bg-green-800 text-white font-bold py-2 px-4 rounded-full text-right">
                                                Submit
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="flex mx-auto max-w-screen-xl">
                        <main class="w-full">
                            <div class="mx-auto max-w-8xl px-4 sm:px-2">
                                <div class="grid grid-cols-1 gap-4">
                                    <div class="flex">
                                        <div class="text-gray-400 font-bold h w-1/2 text-3xl pl-6">Table Detail Specification</div>
                                        <div class="w-full flex justify-end">
                                        <form class="max-w-md w-full border rounded-lg">
                                            <div class="flex">
                                                <div class="relative w-full">
                                                    <input type="search" id="search-dropdown" class="rounded-lg block p-2.5 w-full z-20 text-sm rounded-e-lg border-s-2 border focus:ring-blue-500 bg-gray-700 border-s-gray-700  border-gray-600 placeholder-gray-400 text-white focus:border-blue-500" placeholder="Search Detail Specification" required />
                                                    <button type="submit" class="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white rounded-e-lg border-l border-gray-300 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-500 bg-gray-700">
                                                        <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z"/>
                                                        </svg>
                                    ...
                                    <table class="text-sm text-left rounded rtl:text-right text-gray-00">
                                        ...
                                        <tbody>
                                            @foreach ($detailSpecificaation as $item)
                                                <tr class="odd:bg-gray-900 even:bg-gray-800 border-b border-gray-500">
                                                    <td class="px-6 py-4 gap-2 font-medium text-left text-white">
                                                        {{ $item->DetailSpecification }}
                                                    </td>
                                                    <td>
                                                        <form action="{{ route('admin.manageSpecification.DetailSpecificationDelete', $item->id) }}" method="DELETE">
                                                            @csrf
                                                            @method('delete')
                                                            <button class="font-medium text-white rounded p-1"
                                                                style="background-color:rgb(221, 34, 34);"><svg class="w-6 h-6"
