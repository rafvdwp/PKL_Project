                            ...
                            <div class="flex" style="gap: 4rem;">
                                <label>
                                    <h2 class="text-xl font-bold">
                                        <input type="number" class="w-16 rounded-lg">
                                    </h2>
                                </label>
                                <label>
                                    <h2 class="text-xl font-bold">
                        ...
                        <div class="flex text-2xl mb-3 justify-between">
                            ...
                            <div class="flex gap-5">
                                ...
                                <button data-modal-target="addDesc-{{ $item->id }}"
                                    data-modal-toggle="addDesc-{{ $item->id }}"
                                    class="rounded-xl text-white px-2 h-8" style="background-color: rgb(41, 165, 16)">
                        ...
                        <table id="table-section-{{ $item->id }}" class="w-full divide-y divide-gray-200">
                            <thead class="bg-gray-200">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase">Total Material
                                    </th>
                                </tr>
                            </thead>
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <h2 class="text-xl font-bold uppercase">Nama Unit</h2>
                                </div>
                                <!-- Individual Checkbox -->
                            ...
                            <form class="p-4 md:p-5"
                                ...
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    <div class="col-span-2 sm:col-span-1">
                                        <div class="flex gap-5 mt-2">
                                            <select name="name" id="specification-{{ $item->id }}"
                                                ...
                                                <option value="" selected>Select specification for
                                                    {{ $item->Description_name }}</option>
                                                @if (isset($manageSpecification[$item->id]))
                                                    @foreach ($manageSpecification[$item->id] as $specName)
                                                        @if (!in_array($specName, $existingSpecifications))
                                                            <option value="{{ $specName }}">{{ $specName }}
                                                            </option>
                                                        @endif
                                                    @endforeach
